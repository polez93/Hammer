 ...
 *   https://datatables.net/download/#bs5/dt-1.13.7/b-2.4.2/date-1.5.1/r-2.5.0/sc-2.3.0
 *
 * Included libraries:
 *   DataTables 1.13.7, Buttons 2.4.2, DateTime 1.5.1, Responsive 2.5.0, Scroller 2.3.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.7/b-2.4.2/date-1.5.1/r-2.5.0/sc-2.3.0",
